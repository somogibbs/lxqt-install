...
sudo apt install gnome-core -y && sudo apt install gnome-tweaks gnome-shell-extension-manager gnome-shell-extension-dashtodock gnome-extra-icons libproxy1-plugin-networkmanager network-manager-gnome 
file-roller -y 
