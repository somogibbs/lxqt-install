...
sudo apt -y install libavcodec-extra ffmpeg mpv cpu-x lm-sensors neofetch nala xfce4-terminal btop firefox-esr obsidian-icon-theme fonts-recommended variety unzip
